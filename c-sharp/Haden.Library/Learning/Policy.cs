...
namespace Haden.Library
{
    ...
    public class Policy
    {
        ...
        /// <summary>
        /// A percentage value (0 to 0.9) of how often the learning should explore non-recommended paths. Low values are recommended for higher speed and lower accuracy. Higher values are recommended for  lower speed but higher accuracy. Warning: The search space is exponential.
        /// Default: 0.0
        /// </summary>
        ...
        /// <summary>
        /// The transfer rate (0.0 to 1.0) of information during learning. Default: 0.8. High values provides faster convergence but lower accuracy. Low values provides slower convergence but higher accuracy.
        /// Default: 0.8
        /// </summary>
        ...
        /// <summary>
        /// Enables truncated exploration. This decreases convergence time by updating the label percentages during each state visit. Howerver, it may cause unexplored branches.
        /// Default: false
        /// </summary>
        ...
        /// <summary>
        /// A node based representation of the policy's resulting logic from training. It can be used for classifying a new datavector as well as displaying via HTML or simple text.
        /// </summary>
